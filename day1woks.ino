...
void drawMap() {
  ...
  gfx->print(" GAMEBOY");
    ...
    // middle box
  gfx->drawLine(212, 148, 232, 148, RGB565_PURPLE);
  gfx->drawLine(232, 148, 232, 151, RGB565_PURPLE);
  gfx->drawLine(232, 151, 216, 151, RGB565_PURPLE);
  gfx->drawLine(216, 151, 216, 177, RGB565_PURPLE);
  gfx->drawLine(216, 177, 265, 177, RGB565_PURPLE);
  gfx->drawLine(265, 176, 264, 152, RGB565_PURPLE);
  gfx->drawLine(264, 152, 249, 152, RGB565_PURPLE);
  gfx->drawLine(249, 151, 249, 149, RGB565_PURPLE);
  gfx->drawLine(249, 149, 267, 149, RGB565_PURPLE);
  gfx->drawLine(267, 149, 267, 179, RGB565_PURPLE);
  gfx->drawLine(267, 179, 212, 179, RGB565_PURPLE);
  gfx->drawLine(212, 179, 212, 148, RGB565_PURPLE);
